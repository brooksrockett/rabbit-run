// =============================================================
//  game.js - The conductor. (Week 2)
// =============================================================
//  Same game loop as Week 1, but now the player updates with the
//  MAP passed in (so collision works) and animates as it moves.
// =============================================================
...
class Game {
  ...
  update(dt) {
    this.player.update(dt, this.map);   // NEW: pass the map for collision
